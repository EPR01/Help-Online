...
<body>
    <header>
        <nav class="navbar navbar-expand-md fixed-top bg-white">
            <div class="container">
                <a class="navbar-brand fs-3 fw-semibold text-ford-blue" href="./index.html">Help Online - CSAP</a>
        ...
        <div id="carouselIndex" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../img/frd_mch.jpg" alt="" class="bd-placeholder-img" width="100%" height="100%">
                    <div class="container">
        ...
        <div class=" container menu-options shadow p-3 mb-5 bg-body rounded">
            <div class="row">
                <div class="col-lg-4 p-3 align-items-center">
                    ...
                    <h2>Contactos.</h2>
                    <p>Si necesita ayuda de un area de soporte, no dude en comunicarse con
                        nosotros.</p>
                ...
                <div class="col-lg-4 p-3 align-items-center">
                    ...
                    <p>Si necesita ayuda con un procedimiento relacionado a IT, puede consultar
                        las lecciones de un solo
                        punto.</p>
                                    ...
                                    <form class="row g-3 align-items-center">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control" id="ubicacion-2"
                                                placeholder="Ubicacion exacta a la que se brindara soporte" style="background-color: #f5faff;">
                                        </div>
                                        <div class="mb-2">
                                            ...
                                            <div class="container text-center border p-3 rounded-2" style="background-color: #f5faff;">
                                                <input class="form-check-input" type="radio" value="webex-2"
                                                    ...
                                                    onclick="campoTextoSinCDSID('webex-2')">
                                                <label class="form-check-label me-4"
                                                    for="metodo-contacto-form2">Webex</label>
                                                <input class="form-check-input" type="radio" value="correo-2"
                                                    name="metodo-contacto-form2"
                                                    onclick="campoTextoSinCDSID('correo-2')">
                                                <label class="form-check-label me-4"
                                                    for="metodo-contacto-form2">Correo</label>
