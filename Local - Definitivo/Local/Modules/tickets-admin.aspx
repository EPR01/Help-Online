...
<body>
            ...
            <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <form class="d-flex ms-auto col-md-6" role="search">
                        <input class="form-control me-2" type="search" placeholder="Buscar por numero de #ticket" aria-label="buscar">
            ...
            <div class="row">
                <main class="ms-sm-auto col-lg-12">
                    <div class="d-flex flex-wrap flex-md-nowrap align-items-center mb-2">
                        <h3 class="fs-2">Tickets Administrador</h3>
                    ...
                    <table class="table text-center table-hover align-middle border">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="row-2" data-label="Nombre" style="width: 300px;">Araceli Acacio</td>
                                <td class="row-3" data-label="Descripcion">Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo rem nobis in perferendis inventore eum molestiae ullam beatae obcaecati cum odit eius reprehenderit, hic numquam consequuntur architecto! Rem, culpa magnam!
                                </td>
                                <td class="row-4" data-label="Detalles">
                                    <a class="btn btn-ford-blue btn-sm" data-bs-toggle="modal" data-bs-target="#detallesTicketModal">ver &raquo;</a>

                                </td>
                                <td class="row-5 text-uppercase" data-label="Estado">En proceso
                                </td>
                                <td class="row-6" data-label="Fecha de Registro" style="width: 180px;">02/10/2022 10:00 a.m
                                </td>
                                <td class="row-7" data-label="Asignado">jcampo73</td>
                            </tr>
                            <tr>
                                <td class="row-1" data-label="Ticket"><span class="fw-bold me-2">#</span>1</td>
                                <td class="row-2" data-label="Nombre" style="width: 300px;">Xarisel Pichardo Jaime</td>
                                <td class="row-3" data-label="Descripcion">Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo rem nobis in perferendis inventore eum molestiae ullam beatae obcaecati cum odit eius reprehenderit, hic numquam consequuntur architecto! Rem, culpa magnam!
                                </td>
                                <td class="row-4" data-label="Detalles">
                                    <a class="btn btn-ford-blue btn-sm" data-bs-toggle="modal" data-bs-target="#detallesTicketIngModal">ver &raquo;</a>
                                </td>
                                <td class="row-5 text-uppercase" data-label="Estado">ABIERTO
                                </td>
                                <td class="row-6" data-label="Fecha de Registro" style="width: 180px;">02/10/2022 10:00 a.m
                                </td>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        <div class="offcanvas-header">
            <a class="nav-link dropdown-toggle me-2" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="../img/user.png" alt="img-user" class="rounded-circle me-1" width="60" height="60"> @EPRIMERO
            </a>
            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-light p-2 shadow border-gray-1" style="min-width: 300px;">
        ...
        <div class="offcanvas-body">
            <div class="container p-3">
                <div class="d-grid gap-2">
                    <button class="btn btn-ford-blue" type="button" data-bs-toggle="modal" data-bs-target="#nuevoTicketModal">Nuevo Ticket</button>
    ...
    <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="detallesTicketModal" tabindex="-1" aria-labelledby="detallesTicketModal" aria-hidden="true">
                    ...
                    <div class="row p-2">
                            ...
                            <p>
                                <div class="dropdown-center">
                                    <a class="nav-link dropdown-toggle me-2" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <img src="../img/user.png" alt="img-user" class="rounded-circle me-1" width="30" height="30"> @AACACIO
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-light p-2 shadow" style="min-width: 300px;">
                                        <div class="container text-center">
                                            <div class="mt-3  mb-3">
                                                <img class="rounded-circle" src="../img/user.png" alt="img-user" width="100" height="100">
                                            </div>
                                            ...
                                            <li>
                                                <p class="text-uppercase mt-1 mb-1">
                                                    Departamento: MATERIAL HANDLING MANAGEMENT
                                                </p>
                                            </li>
                                        </div>
                                    </ul>
                        ...
                        <div class="col-12 container bg-light border rounded-2 p-2 mt-2">
                            ...
                            <div class="form-floating mt-2">
                                <textarea class="form-control" placeholder="Problema" id="detalles-problema" style="height: 180px" readonly></textarea>
                                <label for="detalles-problema">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. <br/>
                                    Explicabo rem nobis in perferendis inventore eum  <br/>
                                    molestiae ullam beatae obcaecati cum odit eius  <br/>
                                    reprehenderit, hic numquam consequuntur architecto! <br/>
                                     Rem, culpa magnam!</label>
                            </div>
                        </div>
    ...
    <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="detallesTicketIngModal" tabindex="-1" aria-labelledby="detallesTicketIngModal" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-scrollable">
            <div class=" modal-content">
                <div class="modal-header border-0">
                    <div class="container mt-2">
                        <div class="row text-center">
                            <div class="col">
                                <p class="fs-4">Ticket Abierto #0002</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col text-center bg-success-light " style="font-size: 14px;">
                            <p>
                                <div class="dropdown-center">
                                    <a class="nav-link dropdown-toggle me-2" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <span class="fw-semibold me-2">Por: </span>
                                        <img src="../img/user.png" alt="img-user" class="rounded-circle me-1" width="30" height="30"> @xpichard
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-light p-2 shadow border-gray-1" style="min-width: 300px;">
                                        <div class="container text-center">
                                            <div class="mt-3  mb-3">
                                            ...
                                            <li>
                                                <p class="mt-1 mb-1">
                                                    Xarisel Pichardo Jaime
                                                </p>
                                            </li>
                                            <li>
                                                <p class="mt-1 mb-1">
                                                    Departamento: Manofactura
                                                </p>
                                            </li>
                                            <li>
                                                <p class="text-uppercase mt-1 mb-1">
                                                    Ubicacion: Oficinas de MPL
                                                </p>
                                            </li>
                                        </div>
                                    </ul>
                    ...
                    <div class="row mt-1">
                        ...
                        <form>
                            <div class="container border rounded-2 p-2" style="background-color: #f5faff;">
                                ...
                                <textarea class="form-control" id="detalles-problema" style="height: 160px" readonly></textarea>
                                <div class="border rounded p-2 mt-2 bg-white">
                                    ...
                                    <input class="form-control form-control-sm" id="evidencia" type="file" style="font-size: 12px;">
    ...
    <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="nuevoTicketModal" tabindex="-1" aria-labelledby="nuevoTicketModal" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header border-0">
                    <div class="container mt-2">
